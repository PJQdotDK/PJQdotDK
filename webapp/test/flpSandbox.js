		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title, minapp3",
									"targetURL": "#dkatpsaptestminapp3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dkatpsaptestminapp3-display": {
								"semanticObject": "dkatpsaptestminapp3",
								"action": "display",
								"description": "A Fiori application, minapp3",
								"title": "App Title, minapp3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dk.atp.sap.test.minapp3",
									"url": sap.ui.require.toUrl("dk/atp/sap/test/minapp3")
								}
							}
						}
					}
